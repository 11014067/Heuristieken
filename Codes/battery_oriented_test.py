...
from Heuristieken.switcher import switching_algorithm
# from random import shuffle
from Heuristieken.ask_nicely import ask_nicely
...
with open(os.path.normpath('../../Heuristieken/Information/wijk2_huizen.csv'), 'rb') as csvfile:
# =======

# with open(os.path.join('Information', 'Codes', 'wijk1_huizen.csv'), 'rb') as csvfile:
...
# DRAWING PART
# get the house image
house = read_png(os.path.normpath('../../Heuristieken/Information/house.png'))
house_img = OffsetImage(house, zoom = .05)

# get the battery image
battery = read_png(os.path.normpath('../../Heuristieken/Information/battery.png'))
